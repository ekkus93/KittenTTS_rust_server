...
- [x] Chunk already-generated bytes into the response body
...
- [x] Test stream route returns chunked body
...
- [x] Test startup with valid config
- [x] Test startup failure with missing model
- [x] Test startup failure with missing voices file
- [x] Test startup failure with invalid config
...
- [x] Package only runtime dependencies in final stage
- [x] Install `espeak-ng` in runtime image
- [x] Copy model and voices assets into the image or define a mounted-path strategy
- [x] Expose the configured port
- [x] Add healthcheck if appropriate

### 9.2 Port compose support
- [x] Create or update a compose file
- [x] Support config file mounting
- [x] Support env overrides
- [x] Support model/voices mounting if not baked into the image

### 9.3 Port systemd support
- [x] Create a sample systemd unit file for the Rust binary
- [x] Support config path
- [x] Support environment file or direct env vars
- [x] Set reasonable restart policy

### 9.4 Add deployment docs
- [x] Document local run instructions
- [x] Document Docker build/run instructions
- [x] Document compose instructions
- [x] Document systemd install instructions
- [x] Document `espeak-ng` requirement

### 9.5 Acceptance for Phase 9
- [x] Service can run locally
- [x] Service can run in Docker
- [x] Service can run under systemd
...
- [x] Compare route paths
- [x] Compare status codes
- [x] Compare response headers
- [x] Compare error envelopes
- [x] Compare voice listing shape
- [x] Compare auth behavior
- [x] Compare output format negotiation
- [x] Compare OpenAI route behavior

### 10.2 Add compatibility-focused tests
- [x] Test style-row selection compatibility helper specifically
- [x] Test `clean_text=false` behavior path is used by the HTTP service
- [x] Test unknown voice fallback behavior explicitly
- [x] Test selected voice is logged / carried in request context
- [x] Test text length is recorded in request context
...
- [x] `config/systemd/kittentts-server-rs.service`
...
- [x] `/v1/text-to-speech/{voice_id}/stream` works as pseudo-streaming
...
- [x] `espeak-ng` is handled correctly in runtime packaging
- [x] Docker deployment works
- [x] systemd deployment works
- [x] Compatibility-sensitive behavior is explicitly tested
